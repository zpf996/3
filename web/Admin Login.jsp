...
<body>
    ...
    <div id="login" >
        <div id="login_1" >
            <h2>Please login here</h2>            <form action="action.jsp"  method="post">
                USER ID
                <input type="text" id="UserID"name="UserID" placeholder="ENTER YOUR UserID" required="login"><br/>
                Password
                <input type="password" id="Password" name="Password" placeholder="ENTER YOUR Password" required="login"><br/>
                <br/>
